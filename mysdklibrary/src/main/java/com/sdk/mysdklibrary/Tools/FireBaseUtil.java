...
public class FireBaseUtil {
    ...
    static SetFBTokenCallBack mSetFBTokenCallBack;
...
//                        Toast.makeText(MainActivity.this, msg, Toast.LENGTH_SHORT).show();
    ...
    public static void  getFBToken(Activity activity , SetFBTokenCallBack setFBTokenCallBack){
        mSetFBTokenCallBack=setFBTokenCallBack;
                ...
                .addOnCompleteListener(new OnCompleteListener<String>() {
                    ...
                    public void onComplete(@NonNull Task<String> task) {
                        ...
                        if (!task.isSuccessful()) {
                            ...
                            mSetFBTokenCallBack.setFail("");
                            return ;
                        }

                        // Get new FCM registration token
                        result = task.getResult();
                        mSetFBTokenCallBack.setSuccess(result);
