...
public class HurlStack implements HttpStack {
	 ...
	 * 检查代理，是否cnwap接入
	 */
	static void detectProxy(Context context) {
    ...
    protected HttpURLConnection createConnection(URL url) throws IOException {
    	...
    	if (url != null && urlConn != null) {
            urlConn = (HttpURLConnection) HttpUtils.addhttphead(urlConn);
		}
    	return urlConn;
    }
    ...
    private HttpURLConnection openConnection(URL url, Request<?> request) throws IOException {
        ...
        if ("https".equals(url.getProtocol()) ) {
            SSLContext sslContext = HttpUtils.getSSLContextt(MyApplication.context);
            if(sslContext != null){
    ...
    private static void addBodyIfExists(HttpURLConnection connection, Request<?> request)
        ...
        if (body != null) {
            ...
            // 配置数据长度
            connection.setRequestProperty(CONTENT_LENGTH, String.valueOf(body.length));
            DataOutputStream out = new DataOutputStream(connection.getOutputStream());
            out.write(body);
            out.flush();
            out.close();
