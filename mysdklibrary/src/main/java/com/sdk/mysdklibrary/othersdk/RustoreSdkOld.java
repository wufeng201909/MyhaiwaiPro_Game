...
//                //记录此设备操作过一笔支付，便于漏单查询
//                MyGamesImpl.getSharedPreferences().edit().putBoolean("myths_ru_payed",true).apply();
...
//        boolean ru_payed = MyGamesImpl.getSharedPreferences().getBoolean("myths_ru_payed",false);
//        if(isRuStoreInstalled&&ru_payed){
